...
def setup_logging() -> tuple[logging.Logger, logging.Logger, logging.Logger]:
    """Возвращает (action, error, system)."""
    ...
    action = logging.getLogger("task_actions")
    system = logging.getLogger("system")
    errors = logging.getLogger("task_errors")
    ...
    return action, errors, system


action_logger, error_logger, system_logger = setup_logging()
